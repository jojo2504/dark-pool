...
const FEATURES = [
  {
    ...
    title: "Sealed Bids",
    description:
      "No participant can see others' bids until the auction closes. True dark-pool mechanics on-chain.",
    color: "cyan",
  },
  {
    icon: Lock,
  ...
  },
  {
    ...
    description:
      "Choose between public or invite-only (dark pool) visibility. Control who participates.",
    color: "cyan",
  },
  {
    icon: Zap,
          ...
          {FEATURES.map((feature, i) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                variants={fadeUp}
                className={`group relative rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 hover:bg-white/[0.04] transition-all duration-300 hover:shadow-xl ${colors.glow} ${
